...
4. An interference measurement of the target deployment: the optimized GPU flood loop and CPU LLM decode running concurrently, quantifying what "leveraging idle silicon" costs each side (Section 6).
